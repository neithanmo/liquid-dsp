...
impl FftFiltRrrf {
    ...
    pub fn create(h: &[f32], n: usize) -> LiquidResult<Self> {
        ...
        Ok(Self {
            inner: unsafe {
                raw::fftfilt_rrrf_create(h.as_ptr() as _, h.len() as _, n as _)
            },
        })
    }
...
impl FftFiltCrcf {
    ...
    pub fn create(h: &[f32], n: usize) -> LiquidResult<Self> {
        ...
        Ok(Self {
            inner: unsafe {
                raw::fftfilt_crcf_create(h.as_ptr() as _, h.len() as _, n as _)
            },
        })
    }
...
impl FftFiltCccf {
    ...
    pub fn create(h: &[Complex32], n: usize) -> LiquidResult<Self> {
        ...
        Ok(Self {
            inner: unsafe {
                raw::fftfilt_cccf_create(h.to_ptr() as _, h.len() as _, n as _)
            },
        })
    }
